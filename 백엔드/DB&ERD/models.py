...
class Route(db.Model):
    ...
    node1_id = db.Column(db.ForeignKey('parking_lot.pl_id'))
    node2_id = db.Column(db.ForeignKey('parking_lot.pl_id'))
    node3_id = db.Column(db.ForeignKey('parking_lot.pl_id'))
    ...
    node11 = db.relationship('ParkingLot', primaryjoin='Route.node1_id == ParkingLot.pl_id', backref='parkinglot_parkinglot_parkinglot_routes')
    node21 = db.relationship('ParkingLot', primaryjoin='Route.node2_id == ParkingLot.pl_id', backref='parkinglot_parkinglot_parkinglot_routes_0')
    node31 = db.relationship('ParkingLot', primaryjoin='Route.node3_id == ParkingLot.pl_id', backref='parkinglot_parkinglot_parkinglot_routes')
    node41 = db.relationship('ParkingLot', primaryjoin='Route.node4_id == ParkingLot.pl_id', backref='parkinglot_parkinglot_parkinglot_routes_0')
